...
const ModalContactForm = (props) => {
  ...
  return (
    ...
    <Modal show={show} onHide={handleClose}>
        ...
        <form className="form-horizontal" onSubmit={realizarCompra}>
            <Modal.Body>
            ...
            <Modal.Footer>
                ...
                <button type="submit" className="btn btn-outline-secondary" name="comprar" type="submit">Contactar</button>
            </Modal.Footer>
            </form>
        </Modal>
    </>
